...
class mywindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.areaCal.setWindowTitle('Prediction of urban land area')
        self.suitCal = childWindow_2(self)
        self.suitCal.setWindowTitle('Calibration')
        self.probCal = childWindow_3(self)
        self.probCal.setWindowTitle('Simulation')
        self.valid = childWindow_4(self)
        self.valid.setWindowTitle('Validation')
        self.setLabel = childWindow_5(self)
        self.setLabel.setWindowTitle('Set Label')
        self.setLanduse = childWindow_6(self)
        self.setLanduse.setWindowTitle('Set Land Use')
...
if __name__ == '__main__':
    ...
    splash.show()
    splash.showMessage('Welcome to the LUSD model!',
