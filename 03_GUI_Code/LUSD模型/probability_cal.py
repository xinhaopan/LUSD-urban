...
class Ui_Dialog_3(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_8.setText(_translate("Dialog", "Set Land Use"))
        self.label_8.setText(_translate("Dialog", "Predicted urban land area"))
        self.label_10.setText(_translate("Dialog", "Step"))
        self.label_11.setText(_translate("Dialog", "Disturb constant"))
        self.label_12.setText(_translate("Dialog", "Neighbourhood size"))
        ...
        self.label_5.setText(_translate("Dialog", "*Restricted Data"))
        ...
        self.label_9.setText(_translate("Dialog", "Result path"))
